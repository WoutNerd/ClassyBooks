...
const Pupils =  () => {
    ...
    const [sortedClss, setSortedCllss] = useState(allClss)
    const [sortedReadingLvl, setSortedReadingLvl] = useState(readinglevels)
    const [filterdUsers, setFilterdUsers] = useState(specifiedUsers)
    const [users, setUsers] = useState(specifiedUsers)
